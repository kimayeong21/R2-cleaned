...
[PACK 시연 영상 보기](https://media.githubusercontent.com/media/kimayeong21/R2-cleaned/main/PACK/PACK.mp4)

영상 파일은 용량이 커서 Git LFS로 관리합니다. GitHub 파일 화면에서는 미리보기가 제한될 수 있어, 위 링크는 원본 영상 파일로 바로 연결되도록 설정했습니다.
